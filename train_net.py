...
# sys.path.append('/content/drive/MyDrive/DiffusionDet/DiffusionDet/diffusiondet')
from diffusiondet.dataset_mapper import DiffusionDetDatasetMapper 
from diffusiondet.config import add_diffusiondet_config 
from diffusiondet.test_time_augmentation import DiffusionDetWithTTA
...
def setup(args):
    ...
    # cfg.TEST.AUG.ENABLED = bool(1)
    # cfg.TEST.DETECTIONS_PER_IMAGE = 300
    cfg.OUTPUT_DIR = '/mnt/haopd'
    cfg.freeze()
...
if __name__ == "__main__":
    ...
    def load_custom_dataset(data_path, json_file):
        dataset_dicts = []
        ...
        for i,element in enumerate(data):
            ...
            record = {
                "image_id": element['image_path'],
                "file_name": element['image_path'],
                "height": element["height"],
                "width": element["width"]
            }
            objs = []
            for anno in element["annotation"]:
                x_min = anno['x_min']
                y_min = anno['y_min']
                x_max = anno['x_max']
                y_max = anno['y_max']
                ...
                obj = {
                    ...
                    "category_id": 0 if anno['category'] == "adenomatous" else 1
                }
                objs.append(obj)
    ...
    def register_custom_dataset(name, data_path, json_file):
        DatasetCatalog.register(name, lambda: load_custom_dataset(data_path, json_file))
        MetadataCatalog.get(name).set(thing_classes=["adenomatous","hyperplastic"])
    dataset_name = "polyp_train"
    data_path = "/home/admin_mcn/haopd/DiffusionDet/PolypsSet/train2019/Image"
    json_file = "/home/admin_mcn/haopd/DiffusionDet/PolypsSet/train_instance.json"
    register_custom_dataset(dataset_name, data_path, json_file)

    dataset_name = "polyp_valid"
    data_path = "/home/admin_mcn/haopd/DiffusionDet/PolypsSet/val2019/Image"
    json_file = "/home/admin_mcn/haopd/DiffusionDet/PolypsSet/valid_instance.json"
    register_custom_dataset(dataset_name, data_path, json_file)
